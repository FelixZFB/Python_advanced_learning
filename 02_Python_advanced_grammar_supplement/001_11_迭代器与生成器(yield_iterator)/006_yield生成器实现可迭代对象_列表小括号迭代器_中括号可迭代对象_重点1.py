...
# g就是一个迭代器，迭代器的__iter__返回的是它本身，__next__方法返回的是一个值，
# 上面f()函数调用next方法，返回的都是yield后面的值
# 该处可以同时判断返回的就是g本身，结果是True
print(g.__iter__())
